                ...
                <div class="welcome">
                    ...
                    ?>
                     ...
                     <?php 
                        ...
                        $op= number_format((float)$obtainedPercent, 2, '.', '');
                        //Get Student ID
                        //Get course ID from Student ID then Show full marks based on the course and obtained percentage
                        
                        $_SESSION['USERID']= $userid;
                      
                     ?>
                     You got <h2><?php echo $obtainedMarks; ?></h2>
                     You percentage is <h2><?php echo $op; ?></h2>
